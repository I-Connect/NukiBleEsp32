...
void logCompletionStatus(CompletionStatus completionStatus, bool debug, Print* Log) {
  switch (completionStatus) {
    ...
    case CompletionStatus::Incomplete :
      logMessage("Completion status: incomplete", Log, 4);
      break;
...
void logLockAction(LockAction lockAction, bool debug, Print* Log) {
  switch (lockAction) {
    case LockAction::ActivateRTO :
      logMessage("action: ActivateRTO", Log, 4);
      break;
    case LockAction::DeactivateRTO :
      logMessage("action: DeactivateRTO", Log, 4);
      break;
    case LockAction::ElectricStrikeActuation :
      logMessage("action: ElectricStrikeActuation", Log, 4);
      break;
    case LockAction::ActivateCM :
      logMessage("action: ActivateCM", Log, 4);
      break;
    case LockAction::DeactivateCM :
      logMessage("action: DeactivateCM", Log, 4);
      break;
...
void logAdvancedConfig(AdvancedConfig advancedConfig, bool debug, Print* Log) {
  if (debug) {
    ...
    logMessageVar("doubleButtonPressAction :%d", (unsigned int)(unsigned int)advancedConfig.doubleButtonPressAction, Log, 4);
